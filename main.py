...
application = None  # ⚡ Đặt global để Flask có thể truy cập
...
async def main():
    ...
    # === Đặt webhook ===
    WEBHOOK_URL = f"https://girlhonghot.onrender.com/webhook/{BOT_TOKEN}"
    ...
    # Giữ vòng lặp sống (nếu cần background task)
    while True:
